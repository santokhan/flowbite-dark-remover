  ...
  return (
    <div className="bg-gray-800 h-screen flex flex-col justify-between">
      <div>
        <div className="bg-white">
          <div className="container mx-auto flex gap-2 justify-between items-center h-12">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-3xl font-medium">Flowbite Converter</span>
            </div>
        ...
        <div className="container mx-auto flex flex-col xl:flex-row justify-center items-center lg:items-start gap-8 lg:gap-16 py-10">
